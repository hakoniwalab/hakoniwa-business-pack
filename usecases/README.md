...
the Usecase. The repository must match a `repository.owner/name` pair already represented
by a Catalog component. Do not copy the Recipe into Business Pack solely to make it
